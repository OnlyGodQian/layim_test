...
<head>
	<title>任务管理</title>
	<script src="${ctx}/static/js/layim.js"></script>
	<script src="${ctx}/static/js/layer.min.js"></script>
	<link href="${ctx}/static/css/layim.css" type="text/css" rel="stylesheet"/>
...
<script src="${ctx}/static/js/layim.js"></script>
	...
	<div class="row" id="info" userid="${user.id }" username="${user.username }" userimg="${user.image }">
